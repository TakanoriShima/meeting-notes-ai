...
`secrets.toml` には Gemini API キーを設定します。

```toml
GEMINI_API_KEY = "YOUR_API_KEY"
```

API キーなどの機密情報は GitHub へコミットしないよう、`.gitignore`で管理しています。
...
という業務 AI アプリケーションの基本的な設計・実装を学ぶことを目的としています。

Gemini API、Structured Output、Pydantic、Streamlit、pandas を組み合わせ、生成 AI を業務プロセスへ組み込むための基本的な実装を行いました。
